...
class OrganizersControllerTest < ActionController::TestCase
  ...
  test "should create organizer" do
    assert_difference('Organizer.count') do
      post :create, organizer: { description: @organizer.description, logo_url: @organizer.logo_url, name: @organizer.name, url: @organizer.url }
    end
  ...
  test "should update organizer" do
    patch :update, id: @organizer, organizer: { description: @organizer.description, logo_url: @organizer.logo_url, name: @organizer.name, url: @organizer.url }
    assert_redirected_to organizer_path(assigns(:organizer))
  end
